...
public class SCSIDataIn {
	...
	public SCSIDataIn(){}
	public SCSIDataIn(byte[] BHS,byte[] DataSegment) throws Exception{
	...
	public static void main(String[] args) throws Exception{
		...
		SCSIDataIn after = new SCSIDataIn(BHS,dataS);

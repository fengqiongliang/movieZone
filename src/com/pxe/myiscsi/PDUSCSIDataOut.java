...
public class PDUSCSIDataOut {
	...
	public PDUSCSIDataOut(){}
	public PDUSCSIDataOut(byte[] BHS,byte[] DataSegment) throws Exception{
	...
	public PDUOpcodeEnum getOpcode() {
		return PDUOpcodeEnum.SCSI_DATA_OUT;
	}
	...
	public static void main(String[] args) throws Exception{
		PDUSCSIDataOut original = new PDUSCSIDataOut();
		...
		PDUSCSIDataOut after = new PDUSCSIDataOut(BHS,dataS);

 ...
 * {@link SessionSettingsBuilderComponent} for creating {@link Settings} objects.
 * <p>
...
final class ConnectionSettingsBuilderComponent {
    ...
    ConnectionSettingsBuilderComponent (final Collection<Entry> entries) {
        try {
            ...
            maxRecvDataSegmentLength = SettingsNegotiator.getEntry(TextKeyword.MAX_RECV_DATA_SEGMENT_LENGTH, entries).getIntegerValue();

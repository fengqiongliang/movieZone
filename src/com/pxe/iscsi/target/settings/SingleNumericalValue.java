...
public final class SingleNumericalValue extends NumericalValue {
    ...
    public static final SingleNumericalValue parseSingleNumericValue (final String value) {
        ...
        if (hexMatcher.matches()) return new SingleNumericalValue(parseHexConstantString(value));
        // base 64 constant
        final Matcher base64Matcher = BASE_64_CONSTANT_PATTERN.matcher(value);
        if (base64Matcher.matches()) return new SingleNumericalValue(parseBase64ConstantString(value));
        // none of the above
        return null;
    }
    ...
    public boolean contains (Object value) {
        ...
        if (value instanceof SingleNumericalValue) return contains(((SingleNumericalValue) value).getValue());

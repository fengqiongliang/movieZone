...
/**
 * {@link BooleanResultFunction}s are used by instances of{@link BooleanEntry} during the negotiation of boolean
 * parameters.
 * <p>
...
public enum BooleanResultFunction {
    /**
     * The negotiation result will be <code>true</code> only if both initiator and target support that value.
     */
    AND,
    /**
     * The negotiation result will be <code>true</code> only if either the initiator or the target support that value.
     */
    OR;

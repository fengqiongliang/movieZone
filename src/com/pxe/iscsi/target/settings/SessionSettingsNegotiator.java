...
import com.pxe.iscsi.target.connection.TargetSession;
import com.pxe.iscsi.target.settings.entry.BooleanEntry;
import com.pxe.iscsi.target.settings.entry.Entry;
import com.pxe.iscsi.target.settings.entry.NumericalEntry;
import com.pxe.iscsi.target.settings.entry.StringEntry;
import com.pxe.iscsi.target.settings.entry.Use;
import com.pxe.iscsi.target.util.BinaryLock;
...
public final class SessionSettingsNegotiator extends SettingsNegotiator {
    ...
    protected void updateSettingsBuilderComponent () {
        ...
        sessionSettingBuilderComponent = new SessionSettingsBuilderComponent(currentSettingsId.getAndIncrement() + 1,// settingsId

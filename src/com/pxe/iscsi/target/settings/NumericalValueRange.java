...
public final class NumericalValueRange extends NumericalValue {
    ...
    public boolean contains (final Object value) {
        if (value instanceof NumericalValue) return contains((NumericalValue) value);
        if (value instanceof Integer) return contains((int) ((Integer) value));
        return false;
    }
    ...
    public boolean contains (final NumericalValue value) {
        if (value instanceof SingleNumericalValue) return contains((SingleNumericalValue) value);
        if (value instanceof NumericalValueRange) return contains((NumericalValueRange) value);
        return false;
    }
    ...
    public boolean contains (final NumericalValueRange range) {
        ...
        if (min <= range.getMin() && range.getMax() <= max) return true;
        return false;
    }

 ...
 * {@link ByteBuffer} of sufficient size at an arbitrary position.
 * <p>
 * This interface is implemented by the classes representing sense and response data (as well as components thereof) to
 * SCSI requests, which are returned to the iSCSI initiator in the SCSI Response PDU's data segment.
 * <p>

 ...
 * <p>
 * Sense data returned in the same I_T_L_Q nexus transaction as a CHECK CONDITION status shall be either fixed or
 * descriptor format sense data format based on the value of the D_SENSE bit in the Control mode page.
 * <p>
...
public abstract class SenseData implements ISerializable {
    ...
    /**
     * The {@link #senseKey} and {@link #additionalSenseCodeAndQualifier} fields provide a hierarchy of information. The
    ...
    public static final int getReponseCodeFor (final ErrorType errorType, final SenseDataFormat senseDataFormat) {
        ...
        /*
         * Response codes 0x74 to 0x7E are reserved. Response code 0x7f is vendor specific.
         */
    }
}

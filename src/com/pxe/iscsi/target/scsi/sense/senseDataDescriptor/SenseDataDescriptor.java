...
/**
 * Sense data descriptors are part of sense data and provide specific sense information. A given type of sense data
 * descriptor shall be included in the sense data only when the information it contains is valid.
 * 
...
public abstract class SenseDataDescriptor implements ISerializable {
    ...
    /**
     * This value plus the length of all sub-class-specific fields equal the length in bytes of the serialized sense
     * data descriptor.
     */
    private static final int COMMON_FIELDS_LENGTH = 2;

    /**
     * The descriptor type field determines sense data descriptor's (non-abstract) class.
     * 
     ...
     * 
     * @param descriptorType determines the specific type of the sense data descriptor
     * @param additionalLength the length in bytes of all additional fields

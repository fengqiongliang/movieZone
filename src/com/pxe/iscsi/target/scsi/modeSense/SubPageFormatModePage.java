...
public abstract class SubPageFormatModePage extends ModePage {
    ...
    /**
     * The index of the SUB-PAGE CODE field in the serialized representation of a MODE PAGE using the SUB-PAGE format.
     */
    private static final int SUB_PAGE_CODE_INDEX = 1;

    /**
     * The index of the PAGE LENGTH field in the serialized representation of a MODE PAGE using the SUB-PAGE format.
     */
    private static final int PAGE_LENGTH_INDEX = 2;

    /**
     * Together with {@link ModePage#pageCode} this value determines the kind of information contained in the MODE PAGE.
     */
     ...
     * @param pageCode general description of the contained information
     * @param subPageCode more specific description of the contained information
     * @param pageLength the value of the PAGE LENGTH field
     */
    public SubPageFormatModePage (boolean parametersSaveable, int pageCode, final int subPageCode, int pageLength) {

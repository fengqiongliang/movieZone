...
public final class ModeParameterHeader10 extends ModeParameterHeader {
     ...
     * bytes long and have the format described in SPC-3. If the LONGLBA bit is set to one, the mode parameter block
     * descriptor(s), if any, are each sixteen bytes long and have a format described in a non-general command standard.
     */

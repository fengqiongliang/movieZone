...
/**
 * This abstract class represents Command Descriptor Blocks for the <code>READ</code> and <code>WRITE</code> SCSI
 * commands. This grouping makes sense, since, apart from the different values of the OPERATION CODE field, Read and
 * Write CDBs are identical.
 * 
...
public abstract class ReadOrWriteCdb extends CommandDescriptorBlock {
    ...
    /**
     * The logical block address of the first logical block of data, where data shall be read from or written to.
     * 
     * @see #transferLength
     */
    ...
    /**
     * The TRANSFER LENGTH field specifies the number of contiguous logical blocks of data that shall be read/written
     * and transferred to/from the (initiator's) data-in buffer, starting with the logical block specified by the
     ...
     * 
     * @param buffer the {@link ByteBuffer} containing the CDB
     ...
     * <p>
     * This method must be called if the {@link #logicalBlockAddress} lies outside the bounds of the used medium.
     * 
     ...
     * <p>
     * This method must be called if the {@link #transferLength} field value would result in accessing of out-of-bounds

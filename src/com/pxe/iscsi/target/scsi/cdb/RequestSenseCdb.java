...
public final class RequestSenseCdb extends CommandDescriptorBlock {
    ...
    /**
     * The descriptor format (DESC) bit specifies which sense data format shall be returned. If DESC is set to zero,
     * fixed format sense data shall be returned. If DESC is set to one and descriptor format sense data is supported,

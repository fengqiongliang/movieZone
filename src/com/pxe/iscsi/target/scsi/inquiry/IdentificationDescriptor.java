package com.pxe.iscsi.target.scsi.inquiry;
...
public final class IdentificationDescriptor implements ISerializable {
    ...
    /**
     * The PROTOCOL IDENTIFIER field may indicate the SCSI transport protocol to which the identification descriptor
     * applies. If the ASSOCIATION field contains a value other than 01b (i.e., target port) or 10b (i.e., SCSI target
     * device) or the PIV bit is set to zero, then the PROTOCOL IDENTIFIER field contents are reserved. If the
     * ASSOCIATION field contains a value of 01b or 10b and the PIV bit is set to one, then the PROTOCOL IDENTIFIER
     * field shall contain one of the values defined in SPC-3 to indicate the SCSI transport protocol to which the
    ...
    /**
     * A protocol identifier valid (PIV) bit set to zero indicates the PROTOCOL IDENTIFIER field contents are reserved.
     * If the ASSOCIATION field contains a value of 01b or 10b, then a PIV bit set to one indicates the PROTOCOL
     * IDENTIFIER field contains a valid protocol identifier.
     * <p>
     * If the ASSOCIATION field contains a value other than 01b or 10b, then the PIV bit contents are reserved.
     */
    private final boolean protocolIdentifierValid;

    /**
     * The ASSOCIATION field indicates the entity with which the IDENTIFIER field is associated.
     */
    ...
    /**
     * The IDENTIFIER field contains identifying information about the represented entity.
     */

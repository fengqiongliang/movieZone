package com.pxe.iscsi.target.scsi.readCapacity;
...
public final class ReadCapacity10ParameterData extends ReadCapacityParameterData {
    ...
    /**
     * Specifies the limit to the {@link ReadCapacityParameterData#returnedLogicalBlockAddress} field for READ CAPACITY
     * (10) parameter data.
     * <p>
     * If the value of the RETURNED LOGICAL BLOCK ADDRESS field does not fit completely into the available four bytes,
     * then this value will be inserted instead.
     */

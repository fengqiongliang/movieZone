 ...
 *</pre>
 */
public class TFTPRead extends TFTPPacket{
	private String filename;
	private String mode;
	public TFTPRead(InetAddress remote_ip,int remote_port){
	...
	public TFTPRead(InetAddress remote_ip,int remote_port,String filename,String mode){
		this.remote_ip = remote_ip;
		this.remote_port = remote_port;
		this.opcode  = 1;
	...
	public TFTPRead(DatagramPacket p) throws Exception{
		byte[] data = p.getData();
		short op = (short)data[1];
		if(op!=1) throw new Exception("not TFTP Read packet!! opcode :"+op);
	...
	public String toString(){
		return "TFTPRead Packet : opcode:"+this.opcode+" filename:"+this.filename+" mode:"+this.mode;
	}
}

...
public class MovieController extends BaseController{
	...
	@RequestMapping(value="/showMovie.json",method=RequestMethod.GET)
	...
	public ModelAndView detail(HttpServletRequest request,
						 	   ...
						 	   @RequestHeader(value="User-Agent",required=false,defaultValue="firefox") String userAgent,
						 	   @CookieValue(value="JSESSIONID",required=false,defaultValue="haha") String cookie,
						 	   @RequestParam(value="movieId",required=true)String movieId)throws Exception{
		ModelAndView mv = new ModelAndView();
		mv.addObject("movieId", movieId);
		mv.setViewName("/movie/module/detail");
		return mv;
	}

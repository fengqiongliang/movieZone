...
public class MusicController extends BaseController{
	...
	@RequestMapping(value="/showMusic.json",method=RequestMethod.GET)
	public ModelAndView index(HttpServletRequest request,
		...
		mv.setViewName("/music/index");
		return mv;
	}
	
	@RequestMapping(value="/music.json",method=RequestMethod.GET)
	public ModelAndView detail(HttpServletRequest request,
						 	   HttpServletResponse response,
						 	   HttpSession session,
						 	   @RequestHeader(value="User-Agent",required=false,defaultValue="firefox") String userAgent,
						 	   @CookieValue(value="JSESSIONID",required=false,defaultValue="haha") String cookie,
						 	   @RequestParam(value="musicId",required=true)String musicId)throws Exception{
		ModelAndView mv = new ModelAndView();
		mv.addObject("musicId", musicId);
		mv.setViewName("/music/module/detail");
		return mv;
	}

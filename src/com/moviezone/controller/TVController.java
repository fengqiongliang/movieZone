...
public class TVController extends BaseController{
	...
	@RequestMapping(value="/showTV.json",method=RequestMethod.GET)
	public ModelAndView index(HttpServletRequest request,
		...
		mv.setViewName("/tv/index");
		return mv;
	}
	
	@RequestMapping(value="/tv.json",method=RequestMethod.GET)
	public ModelAndView detail(HttpServletRequest request,
						 	   HttpServletResponse response,
						 	   HttpSession session,
						 	   @RequestHeader(value="User-Agent",required=false,defaultValue="firefox") String userAgent,
						 	   @CookieValue(value="JSESSIONID",required=false,defaultValue="haha") String cookie,
						 	   @RequestParam(value="tvId",required=true)String tvId)throws Exception{
		ModelAndView mv = new ModelAndView();
